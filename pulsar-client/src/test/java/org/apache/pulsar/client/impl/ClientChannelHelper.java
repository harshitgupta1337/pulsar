...
public class ClientChannelHelper {
    ...
    private PulsarDecoder decoder = new PulsarDecoder() {
        ...
        @Override
        protected void handleGetNetworkCoordinateResponse(CommandGetNetworkCoordinateResponse coordinateCommand) {
            queue.offer(CommandGetNetworkCoordinateResponse.newBuilder(coordinateCommand).build());
        }
    };
